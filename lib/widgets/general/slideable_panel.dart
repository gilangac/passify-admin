...
/// Signature for [CustomSlidableActionCustom.onPressed].
typedef SlidableActionCustomCallback = void Function(BuildContext context);
...
class CustomSlidableActionCustom extends StatelessWidget {
  /// Creates a [CustomSlidableActionCustom].
  ///
  /// The [flex], [backgroundColor], [autoClose] and [child] arguments must not
  /// be null.
  ///
  /// The [flex] argument must also be greater than 0.
  const CustomSlidableActionCustom({
    Key? key,
    this.flex = _kFlex,
...
class SlidableActionCustom extends StatelessWidget {
  /// Creates a [SlidableActionCustom].
  ///
  ...
  final SlidableActionCustomCallback? onPressed;
  ...
  Widget build(BuildContext context) {
    ...
    return CustomSlidableActionCustom(
      onPressed: onPressed,
      autoClose: autoClose,
      backgroundColor: backgroundColor,
